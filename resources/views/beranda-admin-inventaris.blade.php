...
<body>
 ...
 <!-- MODAL EDIT tambah peminjaman-->
<div class="modal fade" id="edit-modalpnj" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
$('body').on('click', '.pinjam-post', function () {
            ...
            $.get('databarang/' + data_id + '/edit', function (data) {
                ...
                $('#tombol-simpanpnj').val("create-post");
