...
<body>
    ...
    <nav class="breadcrumbs">
        <a href="/peminjamanview" class="breadcrumbs__item">BARANG</a>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                ...
                                <label for="name" class="col-sm-12 control-label">edit status</label>
                                <div class="col-sm-12">
                                    <select name="status" id="status" placeholder="pilih Status" class="form-control required">
                                        <option value="Menunggu verifikasi">Menunggu</option>
                                        <option value="Dibatalkan oleh admin">Batalkan permintaan</option>
                                        <option value="Disetujui oleh admin">Beri Persetujuan</option>
                                        <option value="Ditolak oleh admin">tolak Permintaan</option>
                                        <option value="Pengembalian jatuh tempo">Peringatkan untuk segera dikembalikan</option>
                                        <option value="Dikembalikan oleh peminjam">Sudah Dikembalikan</option>
                                    </select>
                                </div>
                            </div>
...
$(document).ready(function() {
  ...
  var table = $('#tabelpnj').DataTable({
      ...
      ajax: {
       ...
       url: "{{route('peminjamanAdmin.index')}}",
       type: 'GET',
